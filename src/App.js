...
import LargeBedspreads from './pages/LargeBedspreads';
    ...
    <div className="app">
      ...
      <main role="main">
        <Routes>
          ...
          <Route exact path="/large-bedspreads" element={<LargeBedspreads isMobile={isMobile} hideMain={hideMain} preventScrollReset={true} />} />
